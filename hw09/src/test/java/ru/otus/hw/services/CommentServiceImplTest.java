...
@DisplayName("Сервис по обработке комментариев")
@DataJpaTest
...
public class CommentServiceImplTest {
    ...
    @DisplayName("Обязан вернуть optional с комментарием при поиске по id")
    @Test
    ...
    @DisplayName("Обязан вернуть комментарии по id книги")
    @Test
    ...
    @DisplayName("Обязан создать новый комментарий к книге")
    ...
    @DisplayName("Обязан обновить комментарий по id")
    @DirtiesContext(methodMode = DirtiesContext.MethodMode.AFTER_METHOD)
    @Test
    ...
    @DisplayName("Обязан удалить комментарий по id")
    @DirtiesContext(methodMode = DirtiesContext.MethodMode.AFTER_METHOD)
    @Test
