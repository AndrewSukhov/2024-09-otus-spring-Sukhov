...
public class BookServiceImplTest {
    ...
    @DirtiesContext(methodMode = DirtiesContext.MethodMode.AFTER_METHOD)
    @DisplayName("Обязан вернуть optional с книгой при поиске по id")
    @Test
    ...
    @DirtiesContext(methodMode = DirtiesContext.MethodMode.AFTER_METHOD)
    @DisplayName("Обязан вернуть пустой optional при поиске по id")
    @Test
    ...
    @DirtiesContext(methodMode = DirtiesContext.MethodMode.AFTER_METHOD)
    @DisplayName("Обязан сохранять книгу")
    @Test
    ...
    @DirtiesContext(methodMode = DirtiesContext.MethodMode.AFTER_METHOD)
    @DisplayName("Обязан кинуть исключение, если при сохранении книги автор не найден")
    @Test
    ...
    @DirtiesContext(methodMode = DirtiesContext.MethodMode.AFTER_METHOD)
    @DisplayName("Обязан кинуть исключение, если при сохранении книги" +
    ...
    @DirtiesContext(methodMode = DirtiesContext.MethodMode.AFTER_METHOD)
    @DisplayName("Обязан изменять книгу по id")
    @Test
    ...
    @DirtiesContext(methodMode = DirtiesContext.MethodMode.AFTER_METHOD)
    @DisplayName("Обязан кинуть исключение при обновлении, если при обновлении книги передаваемый id жанра не найден")
    @Test
    ...
    @DirtiesContext(methodMode = DirtiesContext.MethodMode.AFTER_METHOD)
    @DisplayName("Обязан удалить книгу по id")
    @Test
